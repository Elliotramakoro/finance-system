        ...
        <div class="row align-items-center">
            <div class="col-lg-7 hero-content">
                ...
                <div class="animate" style="animation-delay: 0.2s;">
                    <a href="${pageContext.request.contextPath}/register" class="btn btn-primary-custom me-3">Get Started</a>
                    <a href="#features" class="btn btn-outline-custom" style="border-color: white; color: white;">Learn More</a>
                </div>
            ...
            <div class="col-lg-5 d-none d-lg-block">
                <img src="https://placehold.co/500x400/ffffff/333333?text=ERP+Dashboard" alt="Dashboard Preview" class="img-fluid rounded-4 shadow-lg animate" style="animation-delay: 0.2s;">
            </div>
        </div>
    </div>
</section>
...
<section class="cta">
    <div class="container">
        ...
        <a href="${pageContext.request.contextPath}/register" class="btn btn-light-custom">Create Free Account</a>
    </div>
</section>
