...
<%
    ...
    System.out.println("Total products found: " + (products != null ? products.size() : 0));
    ...
    <main class="page-body">
        ...
        <div class="content-card">
            <div class="card-header-bar">
                ...
                <span class="btn-sm-outline">Total: <%= products != null ? products.size() : 0 %> products</span>
            </div>
        ...
        <div class="content-card">
            ...
            <div class="add-product-form">
                <ul class="mb-0" style="padding-left: 20px; color: var(--text-muted); font-size: 0.85rem; line-height: 1.8;">
